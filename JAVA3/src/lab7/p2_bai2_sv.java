 ...
 * @author anhba
 */
public class p2_bai2_sv extends JFrame implements Runnable {
    ...
    Thread t2 = new Thread(p2_bai2_sv.this);
    ...
    public p2_bai2_sv(String title) throws HeadlessException {
        super(title);
        initComponets();
        //  delete.start();
    }
...
//        mesindex = -1;
    ...
    public static void main(String[] args) {
        new p2_bai2("Client").setVisible(true);
        new p2_bai2_sv("Server").setVisible(true);
